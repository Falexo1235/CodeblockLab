...
interface ArrayAssignmentBlockProps {
  arrayName: string
  arrayIndex: string
  value: string
...
export function ArrayAssignmentBlock({
  arrayName,
  arrayIndex,
  value,
  onArrayNameChange,
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Присвоить элементу массива</Text>
      </View>
